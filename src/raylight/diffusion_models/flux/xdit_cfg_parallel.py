...
def cfg_parallel_forward_wrapper(executor, *args, **kwargs):
    ...
    x, timestep, context, y, guidance, ref_latents, control, transformer_options = args
    ...
    result = executor(x, timestep, context, y, guidance, ref_latents, control, transformer_options, **kwargs)
