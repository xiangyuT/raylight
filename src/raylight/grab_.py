...
paths = [
    '.',
    '/home/pandaemon/ComfyUI/custom_nodes/raylight/src',
    '/home/pandaemon/ComfyUI/custom_nodes',
    '/home/pandaemon/ComfyUI/comfy',
    '/home/pandaemon/ComfyUI',
]
...
# Load model
def usp_self_attn_patch(self_attn):
    print(f"[PATCHED] self_attn: {self_attn}")
    self_attn.forward = types.MethodType(usp_attn_forward, self_attn)
    return self_attn
...
block_len = len(model.model.diffusion_model.blocks)
model_options = {
...
model.model.diffusion_model.forward = types.MethodType(usp_dit_forward, model.model.diffusion_model)
print("Patched forward using Comfy patch style.")
